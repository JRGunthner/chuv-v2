...
uint16_t EE_ReadVariable(uint16_t VirtAddress, uint16_t* Data)
{
	...
	PageStartAddress = (uint32_t)(EEPROM_START_ADDRESS + (uint32_t)(ValidPage * PAGE_SIZE)); //PAGE_SIZE = 0x0400, Page size = 1KByte
		// PageStartAddress = 0x0800F800 + (ValidPage * 0x400)
...
static uint16_t EE_VerifyPageFullWriteVariable(uint16_t VirtAddress, uint16_t Data)
{
	...
	uint32_t Address = 0x08010000;
	uint32_t PageEndAddress = 0x080107FF; // 2047
